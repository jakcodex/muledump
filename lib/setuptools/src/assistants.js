...
setuptools.app.assistants.cors = function(force) {
    ...
    setuptools.lightbox.build('muledump-cors', ' \
        ...
        ( (setuptools.state.extension !== true && ['chrome'].indexOf(setuptools.browser) > -1) ? ' \
            ...
            <br><br>Due to this Jakcodex/Muledump no longer recommends Google Chrome for use with Muledump. \
            <br><br>Please consider upgrading to <a href="https://www.opera.com/" target="_blank">Opera</a> or <a href="https://www.firefox.com/" target="_blank">Firefox</a>. \ \
            <br><br>After you decide which, you can go through the <a href="https://github.com/jakcodex/muledump/wiki/Installation-and-Setup" target="_blank">Installation and Setup Guide</a> and restore using a <a href="#" id="archive-backup">Muledump Archive Backup</a>. \
            <br><br>If you would prefer to remain on Chrome then see <a href="https://github.com/jakcodex/muledump/wiki/Chrome-v76-Breaking-Changes" target="_blank">Chrome v76 Breaking Changes</a> in the wiki. \
        ' : '' ) +
        //  opera and firefox extension notice
        ( (setuptools.state.extension !== true && ['opera','firefox'].indexOf(setuptools.browser) > -1) ? ' \
        ...
        ( ( ['chrome','opera','firefox'].indexOf(setuptools.browser) === -1 ) ? ' \
            <br><br><strong style="color: #da281e">Jakcodex/Muledump recommends Opera</strong> \
            <br>If you like your browser and can get it working in a way you like, then great you can disregard this.\
            <br><br>If not then we recommend you install <a href="https://www.opera.com/" target="_blank">Opera</a> and run through the <a href="https://github.com/jakcodex/muledump/wiki/Installation-and-Setup" target="_blank">Installation and Setup Guide</a>.\
        ' : '' ) +
        ' \
