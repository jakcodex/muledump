...
setuptools.app.introduction = function() {
    ...
    setuptools.lightbox.build('introduction', ' \
        Welcome to Muledump Setuptools! This is a new feature designed to make management of your Muledump configuration easier.\
        ...
        <br>&middot; Export full copies of account ROTMG XML data (in JSON format) \
        <br>&middot; Import of local and uploaded accounts.js files \
        <br><br>For more information see <a href="https://jakcodex.github.io/docs/setuptools/index.html" data-featherlight="ajax">SetupTools</a> in the docs. \
    ...
    if ( typeof setuptools.originalAccountsJS === 'object' ) {
        ...
        if ( setuptools.app.config.validateFormat(setuptools.originalAccountsJS, 0) === true ) {
            ...
            setuptools.lightbox.build('introduction', ' \
                <br><br>An accounts.js file was located but the accounts object was not valid. \
        ...
        setuptools.lightbox.build('introduction', ' \
            <br><br><a href="#" class="setuptools app intro import upload">Upload Accounts.js File</a> \
        ');
    ...
    setuptools.lightbox.drawhelp('introduction', 'docs/setuptools/index.html', 'SetupTools Help');
    ...
    $('.setuptools.app.intro.import').click(function() {
...
setuptools.app.config.settings = function() {
    ...
    for ( i = 1; i <= 60; i++ ) setuptools.lightbox.build('settings', ' \
    ...
    $('.setuptools.app.config.settings.action.arrrrgbaaad').click(function() {
        ...
        $('.setuptools.app.erase').click(function () {
            ...
            setuptools.lightbox.display('settings-erase-completed');
...
setuptools.app.backups.index = function() {
    ...
    setuptools.lightbox.drawhelp('backups-index', 'docs/setuptools/backupmanager/index.html', 'Backup Manager Help');
...
setuptools.app.backups.upload = function() {
    ...
    var DoFiles = false;
    if ( setuptools.config.devForcePoint != 'backups-upload' && window.File && window.FileReader && window.FileList && window.Blob ) {
    ...
    setuptools.lightbox.build('backups-upload', ' \
        <br><div class="setuptools app backups uploadResults" style="margin-top: 6px; margin-bottom: 6px; float: left;"></div> \
        <a href="#" class="setuptools app backups uploadData save noclose" style="font-size: 14px; font-weight: bold;">Select a File</a> \
    ');

    setuptools.lightbox.drawhelp('backups-upload', 'docs/setuptools/backups-upload.html', 'Backup Upload Help');
    setuptools.lightbox.settitle('backups-upload', 'Muledump Backup Manager');
    setuptools.lightbox.goback('backups-upload', setuptools.app.backups.index);
    setuptools.lightbox.display('backups-upload', {variant: 'setuptools-medium'});
        ...
        $('input[id="files"]').change(function(e) {
            ...
            reader.onload = function() {
                ...
                if ( reader.error ) {
                    ...
                    try {
                        UploadFileJSON = JSON.parse(UploadFile);
                    } catch(e) {}
                    ...
                    if (typeof UploadFileJSON === 'object' && UploadFileJSON.meta) {
                        ...
                        $('.setuptools.app.backups.uploadResults').html(' \
                            Found ' + Object.keys(UploadFileJSON.accounts.accounts).length + ' accounts and \
                            ' + Object.keys(UploadFileJSON.config).length + ' settings \
                        ');
    ...
    if ( RestoreMethod === 'local' || RestoreMethod === 'upload' ) {
        ...
        if ( BackupFile ) {
            ...
            if ( BackupData = JSON.parse(BackupFile) ) {
                ...
                setuptools.lightbox.drawhelp('backups-restore-confirmed', 'docs/setuptools/backup-restoration.html', 'Backup Restoration Help');
...
setuptools.app.backups.restoreConfirm = function(BackupID, BackupName) {
    ...
    setuptools.lightbox.drawhelp('backups-restore-confirm', 'docs/setuptools/backup-restoration.html', 'Backup Restoration Help');
...
setuptools.app.backups.download = function(BackupID, BackupName, BackupFileName) {
    ...
    if ( BackupData ) {
        ...
        setuptools.lightbox.build('backups-download', 'No backup exists with the name ' + BackupName + '.');
...
setuptools.app.accounts.start = function() {
    ...
    setuptools.lightbox.drawhelp('accounts-start', 'docs/setuptools/initsetup/index.html', 'Account Setup Help');
...
setuptools.app.accounts.manager = function() {
    ...
    setuptools.lightbox.drawhelp('accounts-manager', 'docs/setuptools/initsetup/manual-input.html', 'Account Setup Help');
...
setuptools.app.accounts.massImport = function() {
    ...
    setuptools.lightbox.drawhelp('accounts-massImport', 'docs/setuptools/initsetup/advanced-import.html', 'Advanced Import Help');
...
setuptools.app.accounts.save = function() {
    ...
    setuptools.lightbox.drawhelp('accounts-save', 'docs/setuptools/new-user-setup.html', 'Help');
...
setuptools.app.accounts.AccountsJSImport =  function() {
    ...
    setuptools.lightbox.drawhelp('accounts-accountsjs-index', 'docs/setuptools/initsetup/accountsjs-import.html', 'Accounts.js Import Help');
    setuptools.lightbox.settitle('accounts-accountsjs-index', 'Accounts.js Import');
    setuptools.lightbox.override('accounts-accountsjs-import', 'goback', setuptools.app.accounts.AccountsJSImport);
    setuptools.lightbox.override('accounts-accountsjs-upload', 'goback', setuptools.app.accounts.AccountsJSImport);
...
setuptools.app.accounts.AccountsJSImportLocal = function() {
    ...
    setuptools.lightbox.drawhelp('accounts-accountsjs-import', 'docs/setuptools/initsetup/accountsjs-import.html', 'Accounts.js Import Help');
...
setuptools.app.accounts.AccountsJSImportUpload = function() {
    ...
    setuptools.lightbox.drawhelp('accounts-accountsjs-upload', 'docs/setuptools/accountsjs-upload.html', 'Accounts.js Upload Help');
    setuptools.lightbox.settitle('accounts-accountsjs-upload', 'Accounts.js Import');
    setuptools.lightbox.goback('accounts-accountsjs-upload', setuptools.app.accounts.AccountsJSImport);
    setuptools.lightbox.display('accounts-accountsjs-upload', {variant: 'setuptools-medium'});
        ...
        if ( setuptools.app.checknew() === true ) {
            ...
            if ( setuptools.config.devForcePoint != 'bad-config' && setuptools.data.config.enabled === false ) {
                ...
                if ( typeof setuptools.window.accounts === 'undefined' ||
                    ...
                    setuptools.lightbox.build('bypass-help', ' \
                        ...
                        <br><br>You can enable SetupTools by visiting <a href="#" class="setuptools app intro">SetupTools Introduction</a>. \
                    ');
            ...
            //  setuptools loaded successfully
                ...
                if ( ActiveAccounts === 0 ) {
                    ...
                    $('.setuptools.app.initsetup.accountsjsImport').click(setuptools.app.accounts.AccountsJSImportLocal);
