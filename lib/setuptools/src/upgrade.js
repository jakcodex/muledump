...
setuptools.app.upgrade.seek = function() {
    ...
    */
    ...
    /*
    //  upgrade animations key for preview users (deprecated; will remove soon)
    */
    if ( typeof setuptools.data.config.animations === 'boolean' ) {

        setuptools.data.config.animations = ( setuptools.data.config.animations === true ) ? 1 : 0;
        window.techlog('SetupTools/ClientConfig upgraded animations to new key format', 'force');
