...
setuptools.app.config.settings = function(highlight, section) {
    ...
    var sections = {
        ...
        settings: ['enabled', 'accountsPerPage', 'animations', 'autocomplete', 'automaticBackups', 'autoReloadDays', 'alertNewVersion', 'compression', 'debugging', 'groupsMergeMode', 'hideHeaderText', 'lazySave', 'longpress', 'lowStorageSpace', 'maximumBackupCount', 'menuPosition', 'preventAutoDownload', 'timesync'],
