...
Mule.prototype.query = function(ignore_cache) {
	...
	function onResponse(data) {
        ...
        data = {query: {results: xmlToJson(parser.parseFromString(data,"text/xml"))}};
        /*
		...
		*/
        ...
        if ( data.html ) {
            ...
            if ( data.html.body.parsererror.div['#text'] ) {
                self.log('full error:' + data.html.body.parsererror.div['#text'])
            }
            return;
        }
