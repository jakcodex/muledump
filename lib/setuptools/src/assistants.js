...
setuptools.app.assistants.cors = function(force) {
    ...
    setuptools.lightbox.build('muledump-cors', ' \
        ...
        <br><br><strong style="color: #da281e">CORS can be finicky</strong> \
        <br>If using Chrome click the CORS icon in the upper right corner of your browser. \
        <br><br>Try turning the extension off and back on. If that fails, try removing and re-adding the Intercepted URL. \
        <br><br><strong>Still having troubles?</strong> \
        <br>Head over to Github and read about <a href="https://jakcodex.github.io/muledump/#jakcodex-supportandcontributions" target="_blank">Support</a> or drop into <a href="https://discord.gg/JFS5fqW" target="_blank">Discord</a>. \
    ');
