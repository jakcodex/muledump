...
setuptools.app.assistants.browser = function() {
    ...
    setuptools.lightbox.build('browser-assistant', ' \
            ...
            <div><br>We recommend you switch to Google Chrome or Firefox. Once ready, check out the <a href="https://github.com/jakcodex/muledump/wiki/Installation-and-Setup" target="_blank">Installation and Setup Guide</a> to get setup.</div> \
        ');
    setuptools.lightbox.settitle('browser-assistant', 'Muledump Error');
    setuptools.lightbox.drawhelp('browser-assistant', 'docs/setuptools/help/startup-error', 'Muledump Startup Help');
