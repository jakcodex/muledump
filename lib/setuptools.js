...
setuptools.app.groups.manager = function() {
    ...
    setuptools.lightbox.drawhelp('groups-manager', 'docs/setuptools/groups.html', 'Account Groups Help');
...
setuptools.app.config.generateAccountsJS = function(accountConfig) {
    ...
    return btoa('accounts = ' + JSON.stringify(setuptools.app.config.convert(accountConfig, 0), null, 5) + setuptools.config.accountsJS);
