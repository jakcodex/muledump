...
//  help users with cors issues
setuptools.app.muledump.corsAssist = function() {

    if ( setuptools.state.assistant === true ) return;
    setuptools.state.assistant = true;

    setuptools.lightbox.build('muledump-cors', ' \
        It seems you are experiencing connection issues with Deca\'s servers. Let\'s try and fix that.\
    ...
    setuptools.lightbox.display('muledump-cors', {
        afterClose: function() {
            setuptools.state.assistant = false;
        }
    });
