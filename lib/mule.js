            ...
            */
            ...
            if (this.opt('wawawa')) {
                ...
                function statOut(stat, value, tooltip, color){
                    $('<div>').append($('<div style="color:' + color + ';font-weight:bold">').text(stat + " = " + value).attr('title', tooltip))
                        .appendTo($c);
                }
                ...
                // Total Fame
                var fameColor = "red";
                if(iTotalFame > 400){ fameColor = "#39ef4e"; }
                ...
                var timeColor = "red";
                if(st[20] > 10) { timeColor = "#99f7a4"; }
                if(st[20] > 60){ timeColor = "#39ef4e"; }
                if(st[20] > 60){ timeColor = "gold"; }

                if (ATime === "") {
                    statOut('Active Time', ' < 1 min', FPM, "red")
                } else {
                ...
                var tilesColor = "red";
                if(st[3] > 0) { tilesColor = "#99f7a4"; }
                if(st[3] > 1e6){ tilesColor = "#39ef4e"; }
                ...
                if (TratQuest.length === 0) {
                    if (QuestMiss.length === 0) {
                        statOut('Tunnel Rat', "Complete", QuestMiss.join(' '), "gold")
                    }
                    else {
                        statOut('Tunnel Rat', "Done", QuestMiss.join(' '), "green")
                    }
                }
                else {
                    var tunnelColor = "red";
                    ...
                    if(TratQuest.length < 10) { tunnelColor = "#99f7a4"; tunnelText = "In Progress" }
                    if(TratQuest.length < 5){ tunnelColor = "#39ef4e"; tunnelText = "In Progress" }
                ...
                if (OKill < 1) {
                    statOut('Oryx Kills', OKill, '', 'red')
                }
                else {
                    statOut('Oryx Kills', OKill.toLocaleString(), '', 'gold')
                }
                ...
                var accColor = "red";
                if(iAcc > 25) { accColor = "#99f7a4"; }
                if(iAcc > 50){ accColor = "#39ef4e"; }
                if(iAcc > 75){ accColor = "gold"; }
                ...
                var godsColor = "red";
                if(GodKillRatio > 0) { godsColor = "#99f7a4"; }
                if(GodKillRatio > 10){ godsColor = "#39ef4e"; }
                if(GodKillRatio > 50){ godsColor = "gold"; }
                ...
                var lvlColor = "red";
                if(LvlUp > 0) { lvlColor = "#99f7a4"; }
                if(LvlUp > 100){ lvlColor = "#39ef4e"; }
                ...
                var questsColor = "red";
                if(st[12] > 1) { questsColor = "#99f7a4"; }
                if(st[12] > 500){ questsColor = "#39ef4e"; }
