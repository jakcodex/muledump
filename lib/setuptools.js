            ...
            if ( setuptools.lightbox.builds[id].hasOwnProperty(i) )
                if ( typeof setuptools.lightbox.builds[id][i] === 'object' ) {
                    ...
                    //  check for drawhelp data
                        ...
                        setuptools.lightbox.builds[id].splice(i, 1);
...
setuptools.app.checknew = function() {
    ...
    if ( setuptools.config.devForcePoint != 'newuser' && setuptools.firsttime !== true && setuptools.storage.read('configuration') ) return false;
...
setuptools.app.initsetup.page2 = function() {
    ...
    ');
    setuptools.lightbox.goback('initsetup-page2', setuptools.app.initsetup.index);
