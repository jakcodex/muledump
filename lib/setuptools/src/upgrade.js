...
setuptools.app.upgrade.version = function() {
    ...
    function alertNewVersion() {
        ...
        if ( setuptools.state.loaded === true && setuptools.state.hosted === true ) {
            ...
            ');
            setuptools.lightbox.settitle('muledump-alertNewVersion', '<strong>Muledump Online v0.' + setuptools.version.major + '.' + setuptools.version.minor + ( (setuptools.version.patch !== false) ? '.' + setuptools.version.patch : '.0' ) + '</strong>');
