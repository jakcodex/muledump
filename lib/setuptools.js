...
setuptools.app.introduction = function() {
    ...
    setuptools.lightbox.build('introduction', ' \
        ...
        <br><br>Be sure to check out the <a href="https://jakcodex.github.io/muledump/REQUIREMENTS" target="_blank" class="red">Requirements</a> before starting. \
...
setuptools.app.index = function(config) {
    ...
    if ( setuptools.app.checknew() === true ) {
        ...
        setuptools.lightbox.build('main', ' \
            ...
            <br><br>For more information check out <a href="https://jakcodex.github.io/muledump/" target="_blank">Overview</a> or <a href="#" class="setuptools app intro">Introduction</a>.\
            <br><br>Be sure to check out the <a href="https://jakcodex.github.io/muledump/REQUIREMENTS" target="_blank" class="red">Requirements</a> before starting. \
...
setuptools.init.main = function(window) {
    ...
    if ( setuptools.storage.test() === false ) {
        ...
        if ( setuptools.app.checknew() === true ) setuptools.lightbox.create(' \
            ...
            <br><br>See <a href="https://jakcodex.github.io/muledump/">Overview</a> for more information. \
            ' + ( (setuptools.hosted === true) ? '<br><br>Muledump Online requires local storage support. Download the latest release instead to get started.' : '' ) + ' \
        ');
