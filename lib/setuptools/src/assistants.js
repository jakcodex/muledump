...
setuptools.app.assistants.rendersupdate = function(data) {
    ...
    setuptools.lightbox.build('rendersupdate-assistant', ' \
        ...
        <br><br>Save these files over the existing ones in your Muledump install and then refresh!\
        <br><br>\
        <div style="width: 100%;">\
            <div class="cfleft" style="width: 25%;"><strong>Installed Version</strong></div> \
            <div class="fleft">' + data.currentRenders.toLocaleString() + '</div>\
        </div>\
        <div style="width: 100%;">\
            <div class="cfleft" style="width: 25%;"><strong>Latest Version</strong></div> \
            <div class="fleft">' + data.latestRenders.toLocaleString() + '</div>\
        </div>\
        <br><br>&nbsp;\
