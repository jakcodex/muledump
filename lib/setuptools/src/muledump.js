...
setuptools.app.muledump.drawPortrait = function(c, $c) {
    ...
    chtext.append($('<div style="padding-top: 3px;">').html('<span class="' + seasonal + '">' + cl[0] + ' ' + c.Level + ", " + c.muledump.MaxedStats + "/8" + ', #' + c.id + '</span> ')).append($('<div>').text(c.CurrentFame + ' F ' + c.Exp + ' XP'));
