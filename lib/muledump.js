        ...
        $.ajax({
            ...
            complete: function(xhr) {
                xhr.done(function(data) {
                    ...
                    if ( url ) $.featherlight('<p>Version ' + topver + ' is now available: <a href="' + url + '">' + url + '</a><br><br>The changelog can be viewed here: <a href="https://jakcodex.github.io/muledump/CHANGELOG" target="_blank">https://jakcodex.github.io/muledump/CHANGELOG</a><br><br>You can disable this startup check in the options menu.</p>');
