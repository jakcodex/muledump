...
$(function() {
	...
	$('#update').bind('click', function() {
        if ( setuptools.hosted === false ) {
            ...
            setuptools.lightbox.build('muledump-checkupdates', ' \
				<br><br>See all version notes in the <a href="https://' + setuptools.config.hostedDomain + '/muledump/CHANGELOG" class="drawhelp nostyle" target="_blank">Changelog</a>. \
