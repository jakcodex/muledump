...
setuptools.app.mulequeue.ui.manager = function(guid) {
    ...
    function QueueManagerContext() {
        ...
        $('div.setuptools.link.history').click(setuptools.app.mulequeue.ui.history);
...
setuptools.app.mulequeue.ui.history = function() {
    ...
    var QueueHistoryContext = function() {
        ...
        $('a.mulequeue.link.viewError').click(function() {
            ViewError($(this).attr('data-recordId'));
        });

        $('div.mulequeue.link.manager').click(function() {
            setuptools.lightbox.close();
            setuptools.app.mulequeue.ui.manager();
        });

        $('div.mulequeue.link.refeshHistory').click(function() {
    ...
    var QueueHistoryUpdate = function(page) {
        ...
        QueueHistoryPaginate = setuptools.lightbox.menu.paginate.create(
    ...
    var QueueHistoryPaginate = setuptools.lightbox.menu.paginate.create(
        setuptools.app.mulequeue.history.data,
        undefined,
        'QueueHistory',
