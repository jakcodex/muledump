...
setuptools.lightbox.menu.search.searchExecute = function(state, searchTerm, skip) {
    ...
    var searchName = $(( (typeof state.Modifiers.searchContainer === 'string') ? state.Modifiers.searchContainer : 'div.' + state.ActionContainer ) + ' div.searchName input[name="searchName"]');
