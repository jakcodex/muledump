        ...
        (function ($, window) {
            ...
            $(function () {
                ...
                if ( setuptools.state.preview === false ) {
                    $('#intro > .version').html('Jakcodex BR Update - TadusMod / Muledump ' + ( ( setuptools.state.hosted === false ) ? 'Local' : 'Online' ) + ' <span style="color: #90ccff;">v' + setuptools.version.major + '.' + setuptools.version.minor + '.' + setuptools.version.patch + '</span>');
                } else {
