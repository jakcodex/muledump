...
if ( window.debugging == true ) setInterval(function() {
	console.log("MQ Status --");
	console.log(window.MuleQueue);
}, 5000);
...
$(function() {
	...
	$('#reloader').click(function() {
        window.MuleQueue = {busy: false, active: '', done: 0, total: Object.keys(mules).length, startTime: new Date().toISOString(), mules: {}}
